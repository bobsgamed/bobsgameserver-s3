...
sudo wget -O /etc/init.d/stun_on_reboot.sh http://s3.amazonaws.com/bobsgameserver/stun_on_reboot.sh

# make it executable
sudo chmod +x /etc/init.d/stun_on_reboot.sh

# start on reboot
sudo update-rc.d stun_on_reboot.sh start 20 1 2 3 4 5 .
